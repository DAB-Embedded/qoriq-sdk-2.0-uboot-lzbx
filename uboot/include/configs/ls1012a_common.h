...
#define CONFIG_EXTRA_ENV_SETTINGS        \
    ...
    "usbboot=pfe stop; usb start; fatload usb 0 $kernel_load kernel.itb; bootm $kernel_load\0" \
    "sdboot=pfe stop; mmc rescan; fatload mmc 0 $kernel_load kernel.itb; bootm $kernel_load\0" \
    "netboot=setenv serverip 182.173.170.20; tftp $kernel_load kernel.itb; pfe stop; bootm $kernel_load\0" \
    "sfboot=pfe stop; sf probe 0:0; sf read $kernel_load $kernel_start $kernel_size && bootm $kernel_load\0"
